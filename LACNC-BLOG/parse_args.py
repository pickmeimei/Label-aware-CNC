...
def parse_args():
    ...
    parser.add_argument('--source_dataset', type=str, default='blog2', help="Blog1 Blog2")
    parser.add_argument('--target_dataset', type=str, default='blog1', help="dblpv7  acmv9  citationv1")
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--epochs1', type=int, default=100)#预训练源数据是50，改为5
    parser.add_argument('--epochs', type=int, default=100)#源数据是100，改为5
    parser.add_argument('--lr_cly', type=float, default=0.005)#学习率
    ...
    parser.add_argument('--n_samples', type=str, default='10,2')
