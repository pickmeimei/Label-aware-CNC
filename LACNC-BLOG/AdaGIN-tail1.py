...
def main(args):
    ...
    adj_t, feature_t, label_t, idx_tot_t, b, adj_t_dense, ct, ctn, A_t_num = search_t_data1(
        dataset=args.target_dataset + '.mat', device=device,
        seed=args.seed, is_blog=args.is_blog)

    A_head, A_tail = search_t(
        dataset=args.target_dataset + '.mat', device=device,
        seed=args.seed, is_blog=args.is_blog)
    ...
    for epoch in range(args.epochs):
        ...
        cly_loss_bat_t, tail_micro_f1_t, tail_macro_f1_t, head_micro_f1_t, head_macro_f1_t, embs_whole_t, targets_whole_t = evaluate_tail(
            emb_model, cly_model,
            adj_t,
            feature_t, label_t,
            idx_tot_t,
