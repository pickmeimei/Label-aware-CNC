...
def main(args):
    ...
    adj_s, feature_s, label_s, idx_tot_s, c, cn, adj_s_dense,A_s_num= search_s_datak4(dataset=args.source_dataset + '.mat', device=device,
                                                     seed=args.seed, is_blog=args.is_blog)

    adj_t, feature_t, label_t, idx_tot_t, b ,adj_t_dense,ct,ctn,A_t_num= search_t_datak4(dataset=args.target_dataset + '.mat', device=device,
                                                     seed=args.seed, is_blog=args.is_blog)
